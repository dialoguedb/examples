/**
 * Hello World - DialogueDB + OpenAI Chat Completions API
 *
 ...
 *
 * DialogueDB stores messages with { role, content } — the same shape
 * OpenAI expects, so the conversion is straightforward.
 */
...
async function main() {
  console.log("=== DialogueDB + OpenAI: Hello World ===\n");
